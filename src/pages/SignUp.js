    ...
    <div className="w-full flex bg-primary dark:bg-matBlack-900">
      <div className="w-full max-w-md m-auto bg-offWhite dark:bg-matBlack-900 rounded-lg shadow-2xl py-10 px-16">
        ...
        <form onSubmit={handleFormSubmit}>
          <div>
            <label className="text-matBlack-900 dark:text-primary">
              Full Name
            </label>
            <input
              type="text"
              ...
              className={`w-full p-2 text-blackColor border rounded-md outline-none text-sm transition duration-150 ease-in-out mb-4`}
